...
class TelechatAttention(nn.Module):
    ...
    def forward(
        ...
        # if self.config.flash_attn == False:
...
class TelechatModel(TelechatPreTrainedModel):
    ...
    def forward(
        ...
        input_ids = torch.tensor([[23509, 113348, 112103, 77755, 32185, 112203]])

        print("input_ids of TelechatModel forward",input_ids)
        ...
        print("past_key_values",past_key_values[0])
