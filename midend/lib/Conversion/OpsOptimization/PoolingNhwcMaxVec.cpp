...
class PoolingNhwcMaxOptimizePattern : public ConversionPattern {
public:
  explicit PoolingNhwcMaxOptimizePattern(MLIRContext *context,
                                              int64_t stripParam)
...
//===----------------------------------------------------------------------===//
// PoolingNhwcMaxOptimizePass
//===----------------------------------------------------------------------===//

/// This is a partial lowering linalg pooling max operations to mixture of
/// Arith + Vector operations.
namespace {
class PoolingNhwcMaxOptimizePass
    : public PassWrapper<PoolingNhwcMaxOptimizePass,
                         OperationPass<ModuleOp>> {
public:
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(PoolingNhwcMaxOptimizePass)
  ...
  PoolingNhwcMaxOptimizePass() = default;
  PoolingNhwcMaxOptimizePass(const PoolingNhwcMaxOptimizePass &) {}
...
void PoolingNhwcMaxOptimizePass::runOnOperation() {
  ...
  patterns.add<PoolingNhwcMaxOptimizePattern>(context, strip);
...
void registerPoolingNhwcMaxOptimizePass() {
  PassRegistration<PoolingNhwcMaxOptimizePass>();
}
