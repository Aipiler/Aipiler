...
//===----------------------------------------------------------------------===//
//
// This file implements the Pooling Nhwc Max Optimize.
//
//===----------------------------------------------------------------------===//
...
class Conv2dNhwcFhwcOptimizePattern : public ConversionPattern {
public:
  explicit Conv2dNhwcFhwcOptimizePattern(MLIRContext *context,
  ...
  matchAndRewrite(Operation *op, ArrayRef<Value> operands,
    ...
    const Value zero = insertZeroConstantOp(ctx, rewriter, loc, elementTy);
...
//===----------------------------------------------------------------------===//
// Conv2dNhwcFhwcOptimizePass
//===----------------------------------------------------------------------===//

/// This is a partial lowering linalg pooling max operations to mixture of
/// Arith + Vector operations.
namespace {
class Conv2dNhwcFhwcOptimizePass
    : public PassWrapper<Conv2dNhwcFhwcOptimizePass,
                         OperationPass<ModuleOp>> {
public:
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(Conv2dNhwcFhwcOptimizePass)
  StringRef getArgument() const final {
    return "conv2d-nhwc-fhwc-vectorization";
  }
  StringRef getDescription() const final {
    return "Conv2d_Nhwc_Fhwc Optimize.";
  }
  Conv2dNhwcFhwcOptimizePass() = default;
  Conv2dNhwcFhwcOptimizePass(const Conv2dNhwcFhwcOptimizePass &) {}
...
void Conv2dNhwcFhwcOptimizePass::runOnOperation() {
  ...
  patterns.add<Conv2dNhwcFhwcOptimizePattern>(context, vecsize);
...
void registerConv2dNhwcFhwcOptimizePass() {
  PassRegistration<Conv2dNhwcFhwcOptimizePass>();
}
