...
def import_einsum_graph(
    ...
    arg_device: dict[int, DeviceAffinity] | None,
) -> ExportedProgramIntrinsic:
    from Aipiler.einsum_importer import Einsum_importer

    einsum_importer = Einsum_importer(module_builder)
    entry_func_op = einsum_importer.import_program(
        einsum_graph,
